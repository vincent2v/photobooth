...
<body class="manualwrapper">
	<div class="manual-panel">
		...
		<div class="accordion">
					...
					foreach($configsetup as $panel => $fields) {
						...
						echo '<div class="panel'.$open.'">';
								echo '<div class="panel-heading">';
									echo '<h3><span class="minus">-</span><span class="plus">+</span><span data-l10n="'.$panel.'">'.$panel.'</span></h3>';
								echo '</div>';
								...
								foreach($fields as $key => $field) {
									...
									switch($field['type']) {
										case 'checkbox':
											echo '<p><h4><span data-l10n="'.$key.'">'.$key.'</span></h4></p>';
											echo '<p><span data-l10n="manual_'.$key.'">manual_'.$key.'</span></p><hr>';
											echo '</div>';
											break;
										case 'multi-select':
										case 'range':
										case 'select':
										case 'input':
											echo '<p><h4><span data-l10n="'.$panel.'_'.$key.'"></span></h4></p>';
											echo '<p><span data-l10n="manual_'.$panel.'_'.$key.'">manual_'.$panel.'_'.$key.'</span></p><hr>';
											echo '</div>';
											break;
										case 'color':
										case 'hidden':
			...
			<a href="faq.html" class="btn faq-btn" title="FAQ" target="newwin"><span data-l10n="show_faq"></span> <i class="fa fa-question-circle" aria-hidden="true"></i></a></br>
			</form>
			<a href="https://github.com/andi34/photobooth/wiki" class="btn wiki-btn"><span data-l10n="show_wiki"></span></a>
		</div>
	</div>
